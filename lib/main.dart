...
class InstagramFeedPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // بدنه اصلی که لیست پست‌ها را نمایش می‌دهد
      body: ListView.builder(
        itemCount: 5, // تعداد پست‌هایی که می‌خواهید نمایش داده شود
...
// ویجت اختصاصی برای هر پست اینستاگرام
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        // ۱. بخش بالایی پست (عکس پروفایل و نام کاربری)
        Padding(
        ...
        // ۲. عکس اصلی پست (یک باکس رنگی ساده به عنوان جایگزین عکس)
        Container(
          height: 300,
        ...
        // ۳. دکمه‌های لایک، کامنت و اشتراک‌گذاری
        // Row(
        //   children: [
        //     IconButton(
